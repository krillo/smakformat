...
<?php woo_meta(); ?>
    <link rel="stylesheet" type="text/css" href="<?php echo esc_url(get_bloginfo('stylesheet_url')); ?>?ver=1.2" media="all" />
...
<?php woo_header_inside(); ?>
        ...
        <div id="head-img"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/cia_peppe.png" alt="cia & peppe"/></div>
        <div id="head-slogan"></div>
